...
import 'package:kilyani_app/views/accountScreen/new_password.dart';
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    controller.ForgetThePasswordPageTwo.value =
                                        false;
                                  },
                                  child: Padding(
                                    padding:
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          if (controller
                                            ...
                                            controller.checkAuthData(
                                                controller.anOnepForgetPassword,
                                                controller.anTwoForgetPassword,
                                                "00222${controller.PhoneNumberForgetPassword}");
                                          }
                                        },
                                        child: Container(
                                          alignment: Alignment.center,
