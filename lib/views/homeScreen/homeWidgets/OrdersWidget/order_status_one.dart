...
class OrdersStausOne extends StatelessWidget {
  const OrdersStausOne({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.w),
                    child: Text(
                      "يتم الإن مراجعة طلبك مِن قبل المتجر في حال تم الموافقة سيتم التوجه إلى المرحلة التالية وهي تحديد موعد الوصول والتسليم",
                      style: TextStyle(
                        fontFamily: AppTextStyles.Almarai,
