...
class OrdersStausTwo extends StatelessWidget {
  const OrdersStausTwo({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.w),
                    child: Text(
                      "تم الموافقة على الطلبية من طرف المتجر..سيقوم المتجر بتحديد موعد إيصال الطلبية وإبلاغك",
                      style: TextStyle(
                        fontFamily: AppTextStyles.Almarai,
                        color: Colors.green[700],
                        fontSize: 13.2.sp,
